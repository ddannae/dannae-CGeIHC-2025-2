...
int main()
{
	...
	camera = Camera(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f), -60.0f, 0.0f, 0.3f, 0.3f); //Contro de camara
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::mat4(1.0f);
		color = glm::vec3(0.75f, 0.5f, 1.0f);
		//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.0f));
		...
		// Triangulo 1 cara ROSA
		model = glm::mat4(1.0f);
		color = glm::vec3(1.0, 0.75f, 0.8f);
		//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.0f));

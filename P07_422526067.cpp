...
int main()
{
	...
	pointLights[0] = PointLight(0.5f, 0.5f, 0.5f, // Blanco
		0.0f, 3.0f,
		-8.0f, 1.0f, 6.0f,
		0.3f, 0.2f, 0.1f);
	pointLightCount++;
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::translate(model, glm::vec3(mainWindow.getarticulacion1(), 0.0f,0.0f)); // SE MUEVE CON G
		model = glm::translate(model, glm::vec3(mainWindow.getarticulacion0(), 0.0f, 0.0f)); //SE MUEVE CON F
		// AQUI SE MUEVE LA LUZ CON EL CARRO
		glm::vec3 Faro = glm::vec3(mainWindow.getarticulacion1()+ mainWindow.getarticulacion0(), 2.2f, -6.5f);
		...
		glm::vec3 luz_lampara = glm::vec3(-30.0f, 0.4f, 58.0f);
		spotLights[1].SetFlash(luz_lampara, glm::vec3(0.6f, -1.0f, 0.6f));
